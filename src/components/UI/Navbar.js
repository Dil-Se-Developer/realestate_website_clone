...
const Navbar = (props) => {
  ...
  const loginStatus = useSelector((state) => state.userAgentData.loginStatus);
  const agentStatus = useSelector((state) => state.userAgentData.agentStatus);
    ...
    <div className="general_navbar">
      ...
      {!loginStatus ? (
        <div className="navbar_btn_group">
          ...
          <button onClick={registerHandler} className="navbar_btn register_btn">
            Register
          </button>
        </div>
      ) : (
          ...
          {agentStatus ? (
            <div>
              <button className="addlisting_btn" onClick={addListingHandler}>
                Add Listing <FaLaptopHouse size={"1rem"} />
              </button>
            </div>
          ) : (
            <div></div>
